                ...
                <ul class="sidebar-menu" data-widget="tree">
                    ...
                    <li class="treeview">
                        ...
                        <ul class="treeview-menu">
                            ...
                            <li><a href="<?php echo base_url(); ?>mantrtenimiento/productos"><i class="fa fa-circle-o"></i> Productos</a></li>
                        </ul>
                    </li>
                    <li class="treeview">
                        <a href="#">
                    ...
                    <li class="treeview">
                        ...
                        <ul class="treeview-menu">
                            ...
                            <li><a href="http://localhost/proyecto/index.php/tipotienda/index"><i class="fa fa-circle-o"></i> Tipos de Tiendas</a></li>
                            <li><a href="http://localhost/proyecto/index.php/marca/index"><i class="fa fa-circle-o"></i> Marcas de Productos</a></li>
                        </ul>
                    </li>
                </ul>
            </section>
